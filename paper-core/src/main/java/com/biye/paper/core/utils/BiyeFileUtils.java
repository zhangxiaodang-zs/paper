package com.biye.paper.core.utils;
...
public class BiyeFileUtils {
    ...
    public static boolean downloadFromHttpUrl(String httpUrl, String saveDir, String fileName) {
        ...
        log.info("下载文件[{}]开始，开始时间：{}", fileName, BiyeDateTimeUtil.getTimeformat());
        try {
            ...
            log.info("下载文件[{}]正常结束,结束时间：{}", fileName, BiyeDateTimeUtil.getTimeformat());
            ...
            log.error("下载文件[{}]异常结束,结束时间为：{}，异常信息为：", fileName, BiyeDateTimeUtil.getTimeformat());
    ...
    public static boolean downloadFromFtp(JSONObject ftpInfo, String ftpPath, String saveDir, String fileName) {
        ...
        long startTime = System.currentTimeMillis();
        log.info("FTP下载文件[{}]开始，开始时间：{}", fileName, BiyeDateTimeUtil.getTimeformat());
        ...
        try {
            ...
            log.info("FTP下载文件[{}]正常结束,结束时间：{}", fileName, BiyeDateTimeUtil.getTimeformat());
            ...
            log.error("FTP下载文件[{}]异常结束,结束时间为：{}，异常信息为：", fileName, BiyeDateTimeUtil.getTimeformat());
            log.error(ex.getMessage());
            return false;
        }
    }
    ...
    public static boolean uploadToFtp(JSONObject ftpInfo, String ftpPath, String localPath, String fileName) {
        ...
        long startTime = System.currentTimeMillis();
        log.info("FTP上传文件[{}]开始，开始时间：{}", fileName, BiyeDateTimeUtil.getTimeformat());
        ...
        try {
            ...
            log.info("FTP上传文件[{}]正常结束,结束时间：{}", fileName, BiyeDateTimeUtil.getTimeformat());
            ...
            log.error("FTP上传文件[{}]异常结束,结束时间为：{}，异常信息为：", fileName, BiyeDateTimeUtil.getTimeformat());
            log.error(ex.getMessage());
            return false;
        }
    }
    ...
    public static boolean delFromFtp(JSONObject ftpInfo, String ftpPath, List<String> fileList) {
        ...
        log.info("FTP删除文件开始，开始时间：{}", BiyeDateTimeUtil.getTimeformat());
        try {
            long startTime = System.currentTimeMillis();
            ...
            log.info("FTP上传文件正常结束,结束时间：{}", BiyeDateTimeUtil.getTimeformat());

            long endTime = System.currentTimeMillis();
            log.info("FTP上传文件共耗时{}毫秒!", endTime - startTime);
            return true;
        } catch (Exception ex) {
            log.error("FTP删除文件异常结束,结束时间为：{}，异常信息为：", BiyeDateTimeUtil.getTimeformat());
            log.error(ex.getMessage());
            return false;
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        BiyeFileUtils.uploadToFtp(ftpInfo, "//", "F:\\software", "DRW_freeLT_easeus.exe");
    }
}
